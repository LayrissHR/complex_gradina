...
import { ArrowLeft, Phone, CheckCircle2, ZoomIn } from 'lucide-react'
              ...
              <div className="flex gap-3">
                {room.gallery.map((img, i) => (
                  <button
                    ...
                    className={`relative flex-1 aspect-[4/3] rounded-xl overflow-hidden border-2 transition-all duration-200 group cursor-zoom-in ${
                  ...
                  >
                    ...
                    />
                    <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors flex items-center justify-center">
                      <ZoomIn className="w-5 h-5 text-white opacity-0 group-hover:opacity-100 transition-all duration-300 scale-75 group-hover:scale-100" />
                    </div>
                  </button>
                ))}
              </div>
