...
import { Car, Check, Users, Waves } from "lucide-react";
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-[#213764] text-white">
                    ...
                    <th className="px-6 py-5 font-semibold text-sm uppercase tracking-wider text-center">
                      {t.capacity}
                    </th>
                    <th className="px-6 py-5 font-semibold text-sm uppercase tracking-wider text-center">
                      {t.lowSeason}
                    </th>
                    <th className="px-6 py-5 font-semibold text-sm uppercase tracking-wider text-center bg-[#05B2DC]">
                      {t.highSeason}
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-divider">
                  {rooms.map((room) => (
                    <tr
                      key={room.id}
                      className="hover:bg-[#f0f8fc]/30 transition-colors"
                    >
                      <td className="px-6 py-6 font-medium text-[#213764]">
                        {room.title}
                      </td>
                      ...
                      <td className="px-6 py-6 text-center">
                        <div className="flex flex-col">
                          <span className="text-lg font-bold text-[#213764]">
                      ...
                      <td className="px-6 py-6 text-center bg-[#05B2DC]/5">
                        <div className="flex flex-col">
                          <span className="text-xl font-extrabold text-[#05B2DC]">
                            {room.price_july_aug} €
                          </span>
                          <span className="text-[10px] text-[#05B2DC]/70 uppercase font-bold">
                            /{t.perNight}
                          </span>
                        </div>
                      </td>
            ...
            <div className="bg-[#05B2DC] rounded-2xl p-8 text-white flex flex-col justify-center shadow-lg relative overflow-hidden">
              <div className="relative z-10">
                <h3 className="text-xl font-bold mb-4">
                  {locale === "bg"
                    ? "Специално за апартамените"
                    : locale === "ru"
                      ? "Специально для апартаментов"
                      : "Special for Apartments"}
                </h3>
